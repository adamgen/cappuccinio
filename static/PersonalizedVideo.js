...
import customCss from "./custom.css" with { type: "css" };
import videoThemeCss from "https://cdn.jsdelivr.net/npm/@videojs/themes@1/dist/city/index.css" with { type: "css" };
import videoCss from "https://cdn.jsdelivr.net/npm/video.js@8.20.0/dist/video-js.min.css" with { type: "css" };
...
/**
 * @extends {import("lit-element").LitElement}
 * @type {CustomElementConstructor}
 */
export class PersonalizedVideo extends LitElement {
  static styles = css`
    .mycustomtetsteind {
      width: 100%;
      height: 100%;
  ...
  render() {
    this.shadowRoot.adoptedStyleSheets = [videoCss, videoThemeCss, customCss];
    return html`
      <div class="mycustomtetsteind"></div>
      <div
  ...
  _initAnimation() {
    const container = this.shadowRoot.getElementById(LOTTIE_ELEMENT_ID);
