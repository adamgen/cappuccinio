...
export const getAnimation = async (payload) => {
	...
	// anim.assets[1].layers[1].t.d.k[0].s.t === "ישראל ישראלי"
	anim.assets[1].layers[1].t.d.k[0].s.t = rev(decodeURIComponent(payload.name));
	// anim.assets[2].layers[1].t.d.k[0].s.t === שם
